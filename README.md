...
This repository contains benchmarks for [Autumn](https://www.getautumn.com/), a usage-based billing and entitlements platform.

You can view the evaluation reports at [autumn-benchmark](https://desu-club.github.io/autumn-benchmark/).
